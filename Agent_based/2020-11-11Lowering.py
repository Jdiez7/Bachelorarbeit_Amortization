...
class Car():
    ...
    def run(self):
        while True:
            self.driving = self.initialdriving*(0.5**(1/15))**(self.env.now*self.step)
            #print(self.driving)
...
def main ():
    ...
    if which ==1:
        ...
        ax1.set_ylim(-1,0.1)                           # Achsenlimits x-Achse
        ...
        print('The amortization time is {0}'.format(amor_time(t, G)))
        plt.savefig("/Users/diez/X-Uni/2020_0SoSe/BA/Finalfigs/25relemdisc.pdf")
